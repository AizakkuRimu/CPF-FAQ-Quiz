...
const QUESTIONS = [
  ...
  },
  {
    ...
    "choices": [
      { "text": "The accounts remain open and continue to earn the prevailing CPF interest rate indefinitely.", "correct": false },
      { "text": "The accounts were automatically closed in April 2024 and stop earning prevailing CPF interest.", "correct": true },
      { "text": "The savings are automatically forfeited to the Government.", "correct": false },
      { "text": "The accounts are transferred to a commercial bank of your choice automatically.", "correct": false }
    ],
    ...
    "category": "Account Closure",
    "difficulty": "medium",
    "persona": { "name": "John Smith", "age": 45, "bg": "former expat teacher", "emoji": "👨‍🏫", "salutation": "Mr", "lastname": "Smith" }
  },
  {
    ...
    "choices": [
      ...
      { "text": "31 December 2026", "correct": false },
      { "text": "31 March 2027", "correct": true },
      { "text": "They stop earning interest immediately upon account closure.", "correct": false }
    ],
    ...
    "category": "Account Closure",
    "difficulty": "medium",
    "persona": { "name": "Linda Tan", "age": 50, "bg": "business consultant", "emoji": "👩‍💼", "salutation": "Ms", "lastname": "Tan" }
  },
  {
    ...
    "choices": [
      ...
      { "text": "In the month following their renunciation (e.g., May 2024).", "correct": true },
      { "text": "At the end of the calendar year.", "correct": false },
      { "text": "The account remains open until the member reaches age 55.", "correct": false }
    ],
    ...
    "category": "Account Closure",
    "difficulty": "hard",
    "persona": { "name": "David Low", "age": 32, "bg": "software engineer migrating overseas", "emoji": "💻", "salutation": "Mr", "lastname": "Low" }
  },
  {
    "q": "Can CPF Board disclose account balances over the phone to a member who has renounced their citizenship?",
    "choices": [
      { "text": "Yes, after answering security questions.", "correct": false },
      { "text": "Yes, if the member provides their old NRIC number.", "correct": false },
      { "text": "No, because of difficulties in authenticating identity over the phone.", "correct": true },
      { "text": "Only if the member calls from a registered overseas number.", "correct": false }
    ],
    ...
    "category": "Account Closure",
    "difficulty": "medium",
    "persona": { "name": "Sarah Cheng", "age": 29, "bg": "marketing specialist", "emoji": "👩‍💻", "salutation": "Ms", "lastname": "Cheng" }
  },
  {
    ...
    "category": "Account Closure",
    "difficulty": "hard",
    "persona": { "name": "Michael Wong", "age": 42, "bg": "financial analyst", "emoji": "📊", "salutation": "Mr", "lastname": "Wong" }
  },
  {
    "q": "What is the minimum age to be eligible for the Silver Support Scheme?",
    "choices": [
      { "text": "60 years old", "correct": false },
      { "text": "62 years old", "correct": false },
      { "text": "65 years old", "correct": true },
      { "text": "67 years old", "correct": false }
    ],
    "explanation": "Singapore citizens aged 65 and above are eligible for the Silver Support Scheme if they meet the criteria.",
    "category": "SSS",
    "difficulty": "easy",
    "persona": { "name": "Tan Bee Lian", "age": 64, "bg": "homemaker", "emoji": "👵", "salutation": "Mdm", "lastname": "Tan" }
  },
  {
    "q": "Do you need to apply for the Silver Support Scheme?",
    "choices": [
      { "text": "Yes, via a physical form at CPF Service Centres.", "correct": false },
      { "text": "Yes, through the CPF website every year.", "correct": false },
      { "text": "No, eligibility is automatically reviewed every year by CPF Board.", "correct": true },
      { "text": "No, it is only for those who receive ComCare assistance.", "correct": false }
    ],
    "explanation": "There is no need to apply; CPF Board automatically reviews eligibility every year.",
    "category": "SSS",
    "difficulty": "easy",
    "persona": { "name": "Abu Bakar", "age": 66, "bg": "retired security guard", "emoji": "👴", "salutation": "Mr", "lastname": "Abu" }
  },
  {
    "q": "What is the 'Low lifetime wages' criterion for Silver Support eligibility for those aged 55?",
    "choices": [
      { "text": "Total CPF contributions of not more than $100,000.", "correct": false },
      { "text": "Total CPF contributions of not more than $140,000.", "correct": true },
      { "text": "Annual income never exceeded $30,000.", "correct": false },
      { "text": "Total MediSave balance is less than $50,000.", "correct": false }
    ],
    "explanation": "The 'Low lifetime wages' criterion is total CPF contributions by age 55 of not more than $140,000.",
    "category": "SSS",
    "difficulty": "medium",
    "persona": { "name": "K. Subramaniam", "age": 58, "bg": "cleaner", "emoji": "👨‍🔧", "salutation": "Mr", "lastname": "Subramaniam" }
  },
  {
    "q": "Which HDB flat types are eligible for the Silver Support Scheme?",
    "choices": [
      { "text": "1-room to 4-room flats only.", "correct": false },
      { "text": "1-room to 5-room flats, provided you don't own a larger flat or private property.", "correct": true },
      { "text": "Only rental flats.", "correct": false },
      { "text": "Any HDB flat regardless of size.", "correct": false }
    ],
    "explanation": "Eligible seniors must live in a 1- to 5-room HDB flat and not own a 5-room or larger flat or private property.",
    "category": "SSS",
    "difficulty": "medium",
    "persona": { "name": "Mary Lim", "age": 70, "bg": "retired seamstress", "emoji": "👵", "salutation": "Mdm", "lastname": "Lim" }
  },
  {
    ...
    "choices": [
      ...
      { "text": "It depends on their flat type.", "correct": false }
    ],
    "explanation": "Seniors on ComCare LTA receive a flat amount of $430 per quarter regardless of flat type.",
    "category": "SSS",
    "difficulty": "medium",
    "persona": { "name": "Chua Ah Hock", "age": 75, "bg": "ComCare recipient", "emoji": "👴", "salutation": "Mr", "lastname": "Chua" }
  },
  {
    "q": "When are Silver Support payments made each quarter?",
    "choices": [
      { "text": "On the 1st of every month.", "correct": false },
      { "text": "At the end of each quarter (March, June, September, December).", "correct": true },
      { "text": "In one lump sum in January.", "correct": false },
    ...
    "category": "SSS",
    "difficulty": "easy",
    "persona": { "name": "Fatimah Bte Ali", "age": 68, "bg": "retired kitchen helper", "emoji": "👵", "salutation": "Mdm", "lastname": "Ali" }
  },
  {
    ...
    "choices": [
      ...
      { "text": "Yes, if they meet the income and housing criteria.", "correct": false },
      { "text": "No, only Singapore Citizens are eligible.", "correct": true },
      { "text": "Only if they are married to a Singapore Citizen.", "correct": false }
    ],
    "explanation": "Only Singapore Citizens are eligible for the Silver Support Scheme.",
    "category": "SSS",
    "difficulty": "easy",
    "persona": { "name": "Robert Chen", "age": 66, "bg": "PR, retired engineer", "emoji": "👴", "salutation": "Mr", "lastname": "Chen" }
  },
  {
    "q": "What happens to the Silver Support balance in GovCash if the beneficiary passes away?",
    "choices": [
      { "text": "It is returned to the Government.", "correct": false },
      { "text": "It is credited to their CPF Ordinary Account and distributed via nomination.", "correct": true },
      { "text": "It is paid out to the next-of-kin in cash.", "correct": false },
      { "text": "It is used to pay for funeral expenses automatically.", "correct": false }
    ],
    ...
    "category": "SSS",
    "difficulty": "hard",
    "persona": { "name": "Jane Tan", "age": 40, "bg": "administrator handling estate matters", "emoji": "👩‍💼", "salutation": "Ms", "lastname": "Tan" }
  },
  {
    "q": "How does CPF Board notify members of their Silver Support eligibility for the following year?",
    "choices": [
      { "text": "Via a phone call in January.", "correct": false },
      { "text": "By sending a letter in December of the preceding year.", "correct": true },
      { "text": "Through an advertisement in the newspapers.", "correct": false },
      { "text": "Members must check the LifeSG app themselves; no notification is sent.", "correct": false }
    ],
    "explanation": "Seniors who qualify will receive a notification letter from CPF Board in December of the preceding year.",
    "category": "SSS",
    "difficulty": "easy",
    "persona": { "name": "Lee Siew Hua", "age": 65, "bg": "retired factory worker", "emoji": "👵", "salutation": "Mdm", "lastname": "Lee" }
  },
  {
    "q": "What is the monthly household income per person threshold for the higher Silver Support tier?",
    "choices": [
      { "text": "$1,000 or less", "correct": false },
      { "text": "$1,500 or less", "correct": true },
      { "text": "$1,800 or less", "correct": false },
      { "text": "$2,300 or less", "correct": false }
    ],
    "explanation": "The higher tier of Silver Support is for those with a household monthly income per person of $1,500 or less.",
    "category": "SSS",
    "difficulty": "hard",
    "persona": { "name": "Vikram Singh", "age": 69, "bg": "retired clerk", "emoji": "👴", "salutation": "Mr", "lastname": "Singh" }
  },
  {
    "q": "How can you check if a notification from CPF Board regarding your Yearly Statement of Account is legitimate?",
    "choices": [
      { "text": "Check if the email ends with '@cpf.gov.sg'.", "correct": false },
      { "text": "Check if the email ends with '@e.cpf.gov.sg'.", "correct": true },
      { "text": "Check if the SMS comes from a mobile number starting with 9.", "correct": false },
      { "text": "Call the number provided in the notification to verify.", "correct": false }
    ],
    "explanation": "Legitimate emails from CPF Board regarding the YSOA end with '@e.cpf.gov.sg'.",
    "category": "Accounts Management",
    "difficulty": "medium",
    "persona": { "name": "Jason Teo", "age": 28, "bg": "cybersecurity analyst", "emoji": "👨‍💻", "salutation": "Mr", "lastname": "Teo" }
  },
  {
    "q": "Where has the record of CPF-administered cash grants been moved to from the Yearly Statement of Account?",
    "choices": [
      { "text": "My CPF Mobile App", "correct": false },
      { "text": "YourBenefits@LifeSG", "correct": true },
      { "text": "The annual tax return from IRAS", "correct": false },
      { "text": "A separate physical statement mailed in March", "correct": false }
    ],
    ...
    "category": "Accounts Management",
    "difficulty": "medium",
    "persona": { "name": "Hafiz Ramli", "age": 35, "bg": "delivery driver", "emoji": "🚚", "salutation": "Mr", "lastname": "Ramli" }
  },
  {
    ...
    "category": "Accounts Management",
    "difficulty": "easy",
    "persona": { "name": "Alice Koh", "age": 44, "bg": "accountant", "emoji": "👩‍💼", "salutation": "Ms", "lastname": "Koh" }
  },
  {
    "q": "What should you do if you receive CPF mail at your address that doesn't belong to you or your family?",
    "choices": [
      { "text": "Open it to find the contact details of the recipient.", "correct": false },
      { "text": "Discard it immediately.", "correct": false },
      { "text": "Cross out the address, write 'Recipient not living here', and drop it into a Singapore Post outgoing mailbox.", "correct": true },
      { "text": "Keep it until the person comes to collect it.", "correct": false }
    ],
    ...
    "category": "Member Particulars",
    "difficulty": "easy",
    "persona": { "name": "Tan Wei Ling", "age": 30, "bg": "new homeowner", "emoji": "🏠", "salutation": "Ms", "lastname": "Tan" }
  },
  {
    "q": "How can Singapore Citizens update their residential address with CPF Board?",
    "choices": [
      { "text": "Log in to the CPF website and change it in 'Account settings'.", "correct": false },
      { "text": "Email a copy of their utility bill to CPF Board.", "correct": false },
      { "text": "Update it via ICA's e-Services; CPF will be informed automatically via OSCARS.", "correct": true },
      { "text": "Call the CPF hotline and provide the new address.", "correct": false }
    ],
    ...
    "category": "Member Particulars",
    "difficulty": "medium",
    "persona": { "name": "Rohan Nair", "age": 26, "bg": "engineer", "emoji": "👨‍🔧", "salutation": "Mr", "lastname": "Nair" }
  },
  {
    "q": "What is the 'principal name' used by CPF Board for transactions?",
    "choices": [
      { "text": "The name given at birth.", "correct": false },
      { "text": "The name registered in your NRIC, excluding variants like hanyu pinyin or married names.", "correct": true },
      { "text": "Your nickname as registered in the Singpass app.", "correct": false },
      { "text": "Any name you choose to use on your bank account.", "correct": false }
    ],
    ...
    "category": "Member Particulars",
    "difficulty": "hard",
    "persona": { "name": "Michelle Wong", "age": 34, "bg": "legal secretary", "emoji": "👩‍⚖️", "salutation": "Ms", "lastname": "Wong" }
  },
  {
    "q": "Can you share the same contact details (e.g., mobile number) with another family member in CPF records?",
    "choices": [
      { "text": "No, every member must have a unique mobile number for 2FA.", "correct": false },
      { "text": "Yes, if the contact details are still valid, no further action is needed.", "correct": true },
      { "text": "Only if one member is above age 65.", "correct": false },
      { "text": "Yes, but only for members living at the same address.", "correct": false }
    ],
    ...
    "category": "Member Particulars",
    "difficulty": "medium",
    "persona": { "name": "Ahmad Salleh", "age": 60, "bg": "technician", "emoji": "👨‍🔧", "salutation": "Mr", "lastname": "Salleh" }
  },
  {
    "q": "Under what condition can a parent view their child's CPF statement online?",
    "choices": [
      { "text": "The child is below 18 years old.", "correct": false },
      { "text": "The child is below 21, is a SC/PR, and has received CPF contributions.", "correct": true },
      { "text": "The parent has made a voluntary top-up to the child's account.", "correct": false },
      { "text": "Parents can always view their children's statements regardless of age.", "correct": false }
    ],
    "explanation": "Parents can view statements if both are SC/PR, and the child is below 21 and has received CPF contributions.",
    "category": "Member Particulars",
    "difficulty": "hard",
    "persona": { "name": "Grace Tan", "age": 42, "bg": "mother of two", "emoji": "👩‍👧‍👦", "salutation": "Mrs", "lastname": "Tan" }
  },
  {
    "q": "What is the purpose of the Ordinary Account (OA) in the CPF system?",
    "choices": [
      { "text": "Primarily for hospitalisation expenses.", "correct": false },
      { "text": "For retirement-related financial products only.", "correct": false },
      { "text": "For buying a home, paying for CPF insurance, investment, and education.", "correct": true },
      { "text": "To receive quarterly cash supplements from the government.", "correct": false }
    ],
    "explanation": "The OA savings can be used for housing, CPF insurance, investment, and education.",
    "category": "Digital Services",
    "difficulty": "easy",
    "persona": { "name": "Daniel Lim", "age": 25, "bg": "fresh graduate", "emoji": "👨‍🎓", "salutation": "Mr", "lastname": "Lim" }
  },
  {
    ...
    "choices": [
      ...
      { "text": "Special Account", "correct": true },
      { "text": "MediSave Account", "correct": false },
    ...
    "category": "Digital Services",
    "difficulty": "easy",
    "persona": { "name": "Samuel Ng", "age": 40, "bg": "manager", "emoji": "👨‍💼", "salutation": "Mr", "lastname": "Ng" }
  },
  {
    "q": "What should you do if you have issues logging into CPF digital services using Singpass?",
    "choices": [
      { "text": "Contact the CPF Board's technical team immediately.", "correct": false },
      { "text": "Contact the Singpass Helpdesk directly as it is governed by GovTech.", "correct": true },
      { "text": "Wait for 24 hours for the system to reset.", "correct": false },
      { "text": "Delete your CPF account and create a new one.", "correct": false }
    ],
    "explanation": "Singpass issues should be directed to the Singpass Helpdesk since it's a service governed by GovTech.",
    "category": "Digital Services",
    "difficulty": "medium",
    "persona": { "name": "Fiona Seah", "age": 33, "bg": "freelancer", "emoji": "👩‍💻", "salutation": "Ms", "lastname": "Seah" }
  },
  {
    "q": "Which of these is a recommended troubleshooting step for login issues on 'my cpf' digital services?",
    "choices": [
      { "text": "Turn off your device's date-time automatic setting.", "correct": false },
      { "text": "Clear your browser cache.", "correct": true },
      { "text": "Use a browser that is at least 5 years old for stability.", "correct": false },
      { "text": "Disable your internet connection and try again.", "correct": false }
    ],
    "explanation": "Clearing your browser cache is a standard troubleshooting step for login issues.",
    "category": "Digital Services",
    "difficulty": "medium",
    "persona": { "name": "Benny Tan", "age": 38, "bg": "IT support", "emoji": "👨‍💻", "salutation": "Mr", "lastname": "Tan" }
  },
  {
    "q": "Where can you download the official CPF Mobile app?",
    "choices": [
      { "text": "Only from the CPF website directly.", "correct": false },
      { "text": "Apple App Store or Google Play Store.", "correct": true },
      { "text": "Any third-party APK website.", "correct": false },
      { "text": "It comes pre-installed on all Singapore-registered phones.", "correct": false }
    ],
    "explanation": "CPF Mobile can be downloaded from the Apple App Store or Google Play Store.",
    "category": "Digital Services",
    "difficulty": "easy",
    "persona": { "name": "Chloe Lee", "age": 22, "bg": "student", "emoji": "👩‍🎓", "salutation": "Ms", "lastname": "Lee" }
  },
  {
    "q": "What happens if your MediSave Account (MA) balance exceeds the Basic Healthcare Sum (BHS)?",
    "choices": [
      { "text": "The excess stays in the MA but stops earning interest.", "correct": false },
      { "text": "The excess is automatically withdrawn to your bank account.", "correct": false },
      { "text": "The excess is channelled to your Special Account (if below 55) or Retirement Account (if 55 and above).", "correct": true },
      { "text": "The excess is used to pay for your family's insurance premiums.", "correct": false }
    ],
    "explanation": "Savings above the BHS are channelled to the SA (below 55) or RA (55 and above) if the FRS is met.",
    "category": "Accounts Management",
    "difficulty": "hard",
    "persona": { "name": "Dr. Wong", "age": 56, "bg": "general practitioner", "emoji": "👨‍⚕️", "salutation": "Dr", "lastname": "Wong" }
  },
  {
    ...
    "category": "Accounts Management",
    "difficulty": "hard",
    "persona": { "name": "Tan Cheng Lock", "age": 64, "bg": "logistics manager", "emoji": "👨‍💼", "salutation": "Mr", "lastname": "Tan" }
  },
  {
    "q": "If you turn 65 in 2026 and your MediSave balance is below your BHS of $79,000, are you required to top it up?",
    "choices": [
      { "text": "Yes, it is mandatory to reach the BHS by age 70.", "correct": false },
      { "text": "No, you are not required to top up your MA.", "correct": true },
      { "text": "Yes, your employer will be notified to make extra contributions.", "correct": false },
      { "text": "Only if you have an active hospitalisation claim.", "correct": false }
    ],
    "explanation": "If your balance is less than the BHS at age 65, you are not required to top up your MA.",
    "category": "Accounts Management",
    "difficulty": "medium",
    "persona": { "name": "Rosnah Ismail", "age": 65, "bg": "retired nurse", "emoji": "👩‍⚕️", "salutation": "Mdm", "lastname": "Ismail" }
  },
  {
    "q": "Can you choose to top up your MediSave Account with cash if you haven't reached the BHS?",
    "choices": [
      { "text": "No, MediSave only accepts employer contributions.", "correct": false },
      { "text": "Yes, you can choose to build up your healthcare savings via cash top-ups.", "correct": true },
      { "text": "Only if you are self-employed.", "correct": false },
      { "text": "Only during the month of your birthday.", "correct": false }
    ],
    "explanation": "If you wish to build up healthcare savings, you can choose to top up your MA with cash.",
    "category": "Accounts Management",
    "difficulty": "easy",
    "persona": { "name": "James Koh", "age": 66, "bg": "retired clerk", "emoji": "👴", "salutation": "Mr", "lastname": "Koh" }
  },
  {
    "q": "What happens if you obtain Singapore Citizenship again after closing your CPF account?",
    "choices": [
      { "text": "You start with a fresh zero-balance account.", "correct": false },
      { "text": "You are required to refund your previous CPF savings with accrued interest.", "correct": true },
      { "text": "Your previous savings are forfeited to the government.", "correct": false },
      { "text": "You only need to refund the principal amount without interest.", "correct": false }
    ],
    "explanation": "If you reinstate SC/PR status after closing your account, you must refund CPF savings with accrued interest.",
    "category": "Account Closure",
    "difficulty": "hard",
    "persona": { "name": "Kumar V.", "age": 48, "bg": "returning resident", "emoji": "👨‍💼", "salutation": "Mr", "lastname": "Kumar" }
  },
  {
    "q": "Which of the following is NOT part of the refund required when reinstating citizenship?",
    "choices": [
      { "text": "Savings used for CPF Investment Scheme.", "correct": false },
      { "text": "Savings used for education loans.", "correct": false },
      { "text": "Past employment bonuses paid in cash.", "correct": true },
      { "text": "Savings used to clear tax arrears upon account closure.", "correct": false }
    ],
    ...
    "category": "Account Closure",
    "difficulty": "hard",
    "persona": { "name": "Evelyn Tan", "age": 52, "bg": "legal officer", "emoji": "👩‍⚖️", "salutation": "Ms", "lastname": "Tan" }
  },
  {
    ...
    "choices": [
      ...
      { "text": "Immigration & Checkpoints Authority (ICA)", "correct": false },
      { "text": "Ministry of Home Affairs (MHA)", "correct": false }
    ],
    "explanation": "For enquiries on work permit or employment pass application, contact the Ministry of Manpower.",
    "category": "Account Closure",
    "difficulty": "easy",
    "persona": { "name": "Chen Wei", "age": 36, "bg": "HR manager", "emoji": "👩‍💼", "salutation": "Ms", "lastname": "Chen" }
  },
  {
    "q": "What system does the Government use to conduct means-tests for the Silver Support Scheme?",
    "choices": [
      { "text": "CPF Interest System", "correct": false },
      { "text": "Household Means Eligibility System (HOMES)", "correct": true },
      { "text": "Silver Support Eligibility Portal", "correct": false },
      { "text": "National Income Database", "correct": false }
    ],
    "explanation": "The Household Means Eligibility System (HOMES) supports the Silver Support Scheme in conducting means-tests.",
    "category": "SSS",
    "difficulty": "medium",
    "persona": { "name": "George Lim", "age": 62, "bg": "social worker", "emoji": "👨‍💼", "salutation": "Mr", "lastname": "Lim" }
  },
  {
    "q": "Are seniors living in nursing homes covered by the Silver Support Scheme?",
    "choices": [
      { "text": "No, they are provided for by the home.", "correct": false },
      { "text": "Yes, if they meet the eligibility criteria.", "correct": true },
      { "text": "Only if they have no living children.", "correct": false },
      { "text": "Only if the nursing home is government-run.", "correct": false }
    ],
    ...
    "category": "SSS",
    "difficulty": "medium",
    "persona": { "name": "Sister Theresa", "age": 55, "bg": "nursing home administrator", "emoji": "👩‍⚕️", "salutation": "Sister", "lastname": "Theresa" }
  },
  {
    "q": "What happens if the Government cannot validate your bank account details for Silver Support?",
    "choices": [
      { "text": "The payment is forfeited.", "correct": false },
      { "text": "CPF Board will inform you to update your bank account details.", "correct": true },
      { "text": "The payment will be sent as a cheque to your registered address.", "correct": false },
      { "text": "The money is put into your MediSave account instead.", "correct": false }
    ],
    "explanation": "If details are wrong or the account is closed, the Board will inform you to update your bank account details.",
    "category": "SSS",
    "difficulty": "medium",
    "persona": { "name": "Uncle Jimmy", "age": 72, "bg": "retired taxi driver", "emoji": "👴", "salutation": "Mr", "lastname": "Jimmy" }
  },
  {
    "q": "At which ATMs can you withdraw Silver Support cash benefits via GovCash?",
    "choices": [
      { "text": "DBS/POSB ATMs", "correct": false },
      { "text": "OCBC ATMs", "correct": true },
      { "text": "UOB ATMs", "correct": false },
      { "text": "Any ATM in Singapore", "correct": false }
    ],
    "explanation": "You can withdraw your cash benefit at OCBC ATMs islandwide using your Payment Reference Number (PRN) and NRIC.",
    "category": "SSS",
    "difficulty": "easy",
    "persona": { "name": "Mdm Zaiton", "age": 67, "bg": "homemaker", "emoji": "👵", "salutation": "Mdm", "lastname": "Zaiton" }
  },
  {
    "q": "What two items do you need to withdraw Silver Support from an OCBC ATM?",
    "choices": [
      { "text": "Singpass and NRIC", "correct": false },
      { "text": "8-digit Payment Reference Number (PRN) and NRIC number", "correct": true },
      { "text": "CPF Account Number and ATM card", "correct": false },
      { "text": "Mobile phone for OTP and NRIC", "correct": false }
    ],
    "explanation": "You need your unique 8-digit PRN and your NRIC number to withdraw cash from OCBC ATMs.",
    "category": "SSS",
    "difficulty": "medium",
    "persona": { "name": "Ali Hassan", "age": 68, "bg": "retired gardener", "emoji": "👴", "salutation": "Mr", "lastname": "Hassan" }
  },
  {
    "q": "Can a court-appointed Deputy request CPF statements for a member?",
    "choices": [
      { "text": "No, statements are strictly for the member only.", "correct": false },
      { "text": "Yes, by submitting the Deputyship court order and other required documents.", "correct": true },
      { "text": "Only if the member is above 55 years old.", "correct": false },
      { "text": "Yes, but only via a lawyer's request.", "correct": false }
    ],
    "explanation": "A court-appointed Deputy can request statements by submitting the court order and NRICs.",
    "category": "Accounts Management",
    "difficulty": "hard",
    "persona": { "name": "Sharon Lim", "age": 45, "bg": "lawyer", "emoji": "👩‍⚖️", "salutation": "Ms", "lastname": "Lim" }
  },
  {
    "q": "Which three accounts are mandatory for working Singaporeans and PRs?",
    "choices": [
      { "text": "Ordinary, Special, and Retirement Accounts", "correct": false },
      { "text": "Ordinary, Special, and MediSave Accounts", "correct": true },
      { "text": "Ordinary, MediSave, and Education Accounts", "correct": false },
      { "text": "Special, MediSave, and Investment Accounts", "correct": false }
    ],
    "explanation": "Contributions go into the Ordinary, Special, and MediSave accounts.",
    "category": "Digital Services",
    "difficulty": "easy",
    "persona": { "name": "Kenji Tan", "age": 21, "bg": "intern", "emoji": "👦", "salutation": "Mr", "lastname": "Tan" }
  },
  {
    "q": "Which website provides quick access to CPF schemes and the latest news?",
    "choices": [
      { "text": "life.gov.sg", "correct": false },
      { "text": "cpf.gov.sg", "correct": true },
      { "text": "singpass.gov.sg", "correct": false },
      { "text": "ica.gov.sg", "correct": false }
    ],
    "explanation": "The CPF website (cpf.gov.sg) provides information on schemes, services, and news.",
    "category": "Digital Services",
    "difficulty": "easy",
    "persona": { "name": "Tina Lee", "age": 27, "bg": "journalist", "emoji": "👩", "salutation": "Ms", "lastname": "Lee" }
  },
  {
    "q": "What happens to your participation in CPF schemes after you renounce citizenship and close your account?",
    "choices": [
      { "text": "Schemes like HPS continue until the property is sold.", "correct": false },
      { "text": "Your participation in all schemes administered by CPF Board will cease.", "correct": true },
      { "text": "You can choose to remain in certain schemes by paying cash.", "correct": false },
      { "text": "Participation is suspended but resumes if you return to Singapore.", "correct": false }
    ],
    "explanation": "Upon account closure following renunciation, participation in all CPF-administered schemes will cease.",
    "category": "Account Closure",
    "difficulty": "medium",
    "persona": { "name": "Peter Smith", "age": 39, "bg": "former PR leaving Singapore", "emoji": "👨‍✈️", "salutation": "Mr", "lastname": "Smith" }
  },
  {
    "q": "Can you re-apply for Home Protection Scheme (HPS) if you obtain citizenship again?",
    "choices": [
      { "text": "No, once HPS is cancelled, it cannot be reinstated.", "correct": false },
      { "text": "Yes, if you own a HDB flat with an outstanding loan, subject to health approval.", "correct": true },
      { "text": "Only if you are under age 40.", "correct": false },
      { "text": "Yes, but you must pay a double premium penalty.", "correct": false }
    ],
    ...
    "category": "Account Closure",
    "difficulty": "hard",
    "persona": { "name": "Tan Ming", "age": 44, "bg": "returning citizen", "emoji": "👨", "salutation": "Mr", "lastname": "Tan" }
  },
  {
    "q": "How can you derive the total employment contribution received for the year from your statement?",
    "choices": [
      { "text": "It is the single figure at the bottom of the first page.", "correct": false },
      { "text": "Sum up 'Employee Contribution' under 'You' and 'Employer Contribution' under 'Employer'.", "correct": true },
      { "text": "Multiply your December contribution by twelve.", "correct": false },
      { "text": "Total all 'voluntary' and 'mandatory' contributions.", "correct": false }
    ],
    "explanation": "Total employment contributions are derived by summing 'Employee Contribution' and 'Employer Contribution'.",
    "category": "Accounts Management",
    "difficulty": "medium",
    "persona": { "name": "Wei Kiat", "age": 31, "bg": "HR executive", "emoji": "👨‍💼", "salutation": "Mr", "lastname": "Wei" }
  },
  {
    "q": "What information is specifically EXCLUDED from the breakdown of employer and employee's contributions in the YSOA?",
    "choices": [
      { "text": "Ordinary Wage contributions.", "correct": false },
      { "text": "MediSave contributions as a Self-employed Person.", "correct": true },
      { "text": "Additional Wage contributions.", "correct": false },
      { "text": "Interest earned on the accounts.", "correct": false }
    ],
    ...
    "category": "Accounts Management",
    "difficulty": "hard",
    "persona": { "name": "Serene Ng", "age": 41, "bg": "tax consultant", "emoji": "👩‍💼", "salutation": "Ms", "lastname": "Ng" }
  },
  {
    "q": "What should you check to verify if an SMS notification from CPF Board is legitimate?",
    "choices": [
      { "text": "The sender ID should be 'gov.sg' and begin with 'Central Provident Fund Board'.", "correct": true },
      { "text": "The SMS should contain a link to a website ending in '.com'.", "correct": false },
      { "text": "The SMS should ask for your Singpass password to view the statement.", "correct": false },
      { "text": "The SMS should come from a private 8-digit mobile number.", "correct": false }
    ],
    "explanation": "Legitimate SMS notifications come from 'gov.sg' and begin with 'Central Provident Fund Board'.",
    "category": "Accounts Management",
    "difficulty": "medium",
    "persona": { "name": "Gary Toh", "age": 35, "bg": "banker", "emoji": "👨‍💼", "salutation": "Mr", "lastname": "Toh" }
  },
  {
    "q": "How can you stop receiving hardcopy Yearly Statements of Account?",
    "choices": [
      { "text": "Call the hotline and request to cancel.", "correct": false },
      { "text": "Submit a request online using Singpass login.", "correct": true },
      { "text": "Simply don't collect them from the mailbox.", "correct": false },
      { "text": "Write a letter to the Board's headquarters.", "correct": false }
    ],
    "explanation": "To stop receiving hardcopy YSOA, members can submit a request via Singpass login.",
    "category": "Accounts Management",
    "difficulty": "easy",
    "persona": { "name": "Kelly Chan", "age": 29, "bg": "environmentalist", "emoji": "🌱", "salutation": "Ms", "lastname": "Chan" }
  },
  {
    "q": "What is the primary way for Singapore Citizens to view their Yearly Statement of Account (YSOA)?",
    "choices": [
      { "text": "By requesting it at any Singapore Post outlet.", "correct": false },
      { "text": "Logging in to 'my cpf' digital services.", "correct": true },
      { "text": "Checking their quarterly physical mailer.", "correct": false },
      { "text": "Calling the CPF automated phone system.", "correct": false }
    ],
  ...
  },
  {
    ...
    "choices": [
      { "text": "Yes, if they have lived in Singapore for 20 years.", "correct": false },
      { "text": "No, it is only for Singapore Citizens.", "correct": true },
      { "text": "Yes, but they receive a lower amount.", "correct": false },
      { "text": "Only if they are married to a Singapore Citizen.", "correct": false }
    ],
    "explanation": "The Silver Support Scheme is specifically designed to support elderly Singapore Citizens.",
    "category": "SSS",
    "difficulty": "medium",
    "persona": { "name": "Mr. Lee", "age": 66, "bg": "PR living in Singapore", "emoji": "🇸🇬", "salutation": "Mr", "lastname": "Lee" }
  },
  {
    ...
    "category": "SSS",
    "difficulty": "hard",
    "persona": { "name": "Mdm Rosnah", "age": 70, "bg": "living in a 3-room flat", "emoji": "👵", "salutation": "Mdm", "lastname": "Rosnah" }
  },
  {
    "q": "Does the Silver Support Scheme provide the same payout for 4-room and 3-room HDB flat dwellers?",
    "choices": [
      { "text": "No, 4-room flat dwellers get less.", "correct": false },
      { "text": "Yes, both receive $720 per quarter (from 2025).", "correct": true },
      { "text": "No, 3-room flat dwellers get more.", "correct": false },
      { "text": "It depends on the location of the flat.", "correct": false }
    ],
    "explanation": "Both 3-room and 4-room HDB flat dwellers fall into the same tier, receiving $720 per quarter from 2025.",
    "category": "SSS",
    "difficulty": "hard",
    "persona": { "name": "Uncle Tan", "age": 68, "bg": "living in a 4-room flat", "emoji": "👴", "salutation": "Mr", "lastname": "Tan" }
  },
  {
    ...
    "choices": [
      ...
      { "text": "They are not eligible.", "correct": false }
    ],
    "explanation": "Eligible seniors in 5-room HDB flats receive the lowest tier of $430 per quarter.",
    "category": "SSS",
    "difficulty": "hard",
    "persona": { "name": "Mr. Gupta", "age": 71, "bg": "living in a 5-room flat", "emoji": "👴", "salutation": "Mr", "lastname": "Gupta" }
  },
  {
    "q": "If an eligible senior lives in a nursing home, can they still receive Silver Support?",
    "choices": [
      { "text": "No, nursing home residents are excluded.", "correct": false },
      { "text": "Yes, they will be assessed based on their last HDB flat type before moving.", "correct": true },
      { "text": "Only if they pay for the home using CPF.", "correct": false },
      { "text": "Yes, they automatically get the maximum amount.", "correct": false }
    ],
    "explanation": "Seniors in nursing homes remain eligible if they meet the lifetime wages and household support criteria.",
    "category": "SSS",
    "difficulty": "medium",
    "persona": { "name": "Nurse Jane", "age": 30, "bg": "helping a resident", "emoji": "🏥", "salutation": "Ms", "lastname": "Jane" }
  },
  {
    "q": "How can you update your bank account details specifically for Silver Support payouts?",
    "choices": [
      { "text": "By calling the SSS hotline.", "correct": false },
      { "text": "By logging into 'my cpf' digital services and updating your bank account for 'Board's payments to you'.", "correct": true },
      { "text": "By visiting any OCBC ATM.", "correct": false },
      { "text": "You must send a physical cheque book leaf.", "correct": false }
    ],
    "explanation": "You can update your bank account for all Board payments, including SSS, via the official digital services.",
    "category": "SSS",
    "difficulty": "medium",
    "persona": { "name": "Wei Kiat", "age": 28, "bg": "helping his father", "emoji": "💻", "salutation": "Mr", "lastname": "Wei Kiat" }
  },
  {
    "q": "What is 'GovCash' in the context of Silver Support?",
    "choices": [
      { "text": "A new digital currency.", "correct": false },
      { "text": "A payment method for those without a linked bank account.", "correct": true },
      { "text": "A voucher for grocery stores.", "correct": false },
      { "text": "A loan from the government.", "correct": false }
    ],
    ...
    "category": "SSS",
    "difficulty": "medium",
    "persona": { "name": "Auntie Sim", "age": 73, "bg": "no bank account", "emoji": "🏧", "salutation": "Mdm", "lastname": "Sim" }
  },
  {
    "q": "Can a senior opt out of the Silver Support Scheme?",
    "choices": [
      { "text": "No, it is mandatory.", "correct": false },
      { "text": "Yes, by writing to the CPF Board.", "correct": true },
      { "text": "Only if they are leaving the country.", "correct": false },
      { "text": "Only if they have more than $1 million.", "correct": false }
    ],
    "explanation": "While it is an automatic benefit, seniors can choose to opt out by contacting the Board.",
    "category": "SSS",
    "difficulty": "medium",
    "persona": { "name": "Mr. Wong", "age": 67, "bg": "prefers not to receive aid", "emoji": "✉️", "salutation": "Mr", "lastname": "Wong" }
  },
  {
    "q": "Are Silver Support cash supplements subject to Income Tax?",
    "choices": [
      { "text": "Yes, they are considered income.", "correct": false },
      { "text": "No, they are tax-exempt.", "correct": true },
      { "text": "Only if your total income exceeds $20,000.", "correct": false },
      { "text": "Yes, but at a special 2% rate.", "correct": false }
    ],
    "explanation": "Silver Support payments are government supplements and are not taxable.",
    "category": "SSS",
    "difficulty": "easy",
    "persona": { "name": "Mr. Tan", "age": 69, "bg": "calculating taxes", "emoji": "📝", "salutation": "Mr", "lastname": "Tan" }
  },
  {
    "q": "What happens to your MediShield Life coverage if your CPF account is closed due to renunciation?",
    "choices": [
      { "text": "It continues until you turn 90.", "correct": false },
      { "text": "It is terminated upon account closure.", "correct": true },
      { "text": "You can pay for it via credit card instead.", "correct": false },
      { "text": "It is transferred to a private insurer automatically.", "correct": false }
    ],
    "explanation": "All CPF-administered schemes, including MediShield Life, cease once the CPF account is closed.",
    "category": "Account Closure",
    "difficulty": "hard",
    "persona": { "name": "Elena", "age": 42, "bg": "ex-citizen", "emoji": "🏥", "salutation": "Ms", "lastname": "Elena" }
  },
  {
    "q": "Can you still use your CPF Ordinary Account to pay for your HDB mortgage after renouncing your PR status?",
    "choices": [
      { "text": "Yes, for a 3-year grace period.", "correct": false },
      { "text": "No, housing payments from CPF cease when the account is closed.", "correct": true },
      { "text": "Only if you have a job in Singapore.", "correct": false },
      { "text": "Yes, but you must pay in cash first and claim later.", "correct": false }
    ],
    ...
    "category": "Account Closure",
    "difficulty": "hard",
    "persona": { "name": "Paul", "age": 39, "bg": "former PR", "emoji": "🏠", "salutation": "Mr", "lastname": "Paul" }
  },
  {
    "q": "If you renounce citizenship and have outstanding tax arrears, how does the Board handle your CPF savings?",
    "choices": [
      { "text": "You must pay the tax separately.", "correct": false },
      { "text": "The Board may use your savings to clear past debts like tax arrears before transferring the balance.", "correct": true },
      { "text": "The tax is waived.", "correct": false },
      { "text": "Your account cannot be closed until tax is paid.", "correct": false }
    ],
    ...
    "category": "Account Closure",
    "difficulty": "hard",
    "persona": { "name": "John", "age": 50, "bg": "overseas move", "emoji": "📊", "salutation": "Mr", "lastname": "John" }
  },
  {
    "q": "What happens if you have no Singpass but need to request your CPF statement after your account is closed?",
    "choices": [
      { "text": "You cannot get it.", "correct": false },
      { "text": "You must submit a manual request form to the Board.", "correct": true },
      { "text": "You can ask a friend with Singpass to check for you.", "correct": false },
      { "text": "You must fly back to Singapore.", "correct": false }
    ],
    ...
    "category": "Account Closure",
    "difficulty": "medium",
    "persona": { "name": "George", "age": 55, "bg": "living in Canada", "emoji": "🇨🇦", "salutation": "Mr", "lastname": "George" }
  },
  {
    "q": "When reinstating citizenship, do you need to refund CPF money used for education?",
    "choices": [
      { "text": "No, only the cash withdrawn.", "correct": false },
      { "text": "Yes, any savings used for participation in CPF schemes (like Education) must be refunded.", "correct": true },
      { "text": "Only if the child is still studying.", "correct": false },
      { "text": "No, education is a gift.", "correct": false }
    ],
    ...
    "category": "Account Closure",
    "difficulty": "hard",
    "persona": { "name": "Sarah", "age": 45, "bg": "returning citizen", "emoji": "🎓", "salutation": "Ms", "lastname": "Sarah" }
  },
  {
    "q": "How can you update your email address for CPF notifications?",
    "choices": [
      { "text": "Email the Board from your new address.", "correct": false },
      { "text": "Update it via 'Account settings' in 'my cpf' using Singpass.", "correct": true },
      { "text": "Update it at an AXS machine.", "correct": false },
      { "text": "Call the hotline and speak to an officer.", "correct": false }
    ],
    "explanation": "Email and mobile updates are managed securely through the Account settings online.",
    "category": "Member Particulars",
    "difficulty": "easy",
    "persona": { "name": "Wei Ling", "age": 26, "bg": "young professional", "emoji": "📧", "salutation": "Ms", "lastname": "Wei Ling" }
  },
  {
    "q": "What should you do if your child's name does not appear on your Child Dashboard?",
    "choices": [
      { "text": "Wait until they turn 21.", "correct": false },
      { "text": "Write to the Board with their birth certificate and citizenship certificate.", "correct": true },
      { "text": "The child must create their own Singpass first.", "correct": false },
      { "text": "Contact the school principal.", "correct": false }
    ],
    ...
    "category": "Member Particulars",
    "difficulty": "medium",
    "persona": { "name": "Mei Ling", "age": 32, "bg": "new mother", "emoji": "👶", "salutation": "Ms", "lastname": "Mei Ling" }
  },
  {
    "q": "Can you see your child's healthcare claims from 2 years ago on the dashboard?",
    "choices": [
      { "text": "Yes, history goes back 10 years.", "correct": false },
      { "text": "No, only the last 15 months of claims are visible.", "correct": true },
      { "text": "Yes, but only if they were hospitalized.", "correct": false },
      { "text": "No, healthcare claims are private.", "correct": false }
    ],
    ...
    "category": "Member Particulars",
    "difficulty": "medium",
    "persona": { "name": "Hassan", "age": 38, "bg": "father", "emoji": "🏥", "salutation": "Mr", "lastname": "Hassan" }
  },
  {
    "q": "If you changed your name in your NRIC, how long does it take for CPF to be updated?",
    "choices": [
      { "text": "You must wait 30 days.", "correct": false },
      { "text": "It is updated automatically in our records without needing to inform us separately.", "correct": true },
      { "text": "You must visit a CPF Service Centre with the deed poll.", "correct": false },
      { "text": "It only updates when you make a contribution.", "correct": false }
    ],
    "explanation": "For SCs/PRs, name changes in NRIC are automatically synced with CPF Board records.",
    "category": "Member Particulars",
    "difficulty": "easy",
    "persona": { "name": "Lily", "age": 29, "bg": "changed name recently", "emoji": "📝", "salutation": "Ms", "lastname": "Lily" }
  },
  {
    "q": "Can you use a different mailing address for CPF letters than the one on your NRIC?",
    "choices": [
      { "text": "Yes, you can register a separate mailing address.", "correct": false },
      { "text": "No, letters are sent to the residential address on your Singapore Identity Card by default.", "correct": true },
      { "text": "Only if you are a landlord.", "correct": false },
      { "text": "Yes, but you must pay for postage.", "correct": false }
    ],
    ...
    "category": "Member Particulars",
    "difficulty": "medium",
    "persona": { "name": "Ben", "age": 31, "bg": "renting a house", "emoji": "📬", "salutation": "Mr", "lastname": "Ben" }
  },
  {
    "q": "What is a recommended first step if you have trouble logging into 'my cpf'?",
    "choices": [
      { "text": "Buy a new laptop.", "correct": false },
      { "text": "Clear your browser cache.", "correct": true },
      { "text": "Call the police.", "correct": false },
      { "text": "Delete your CPF account.", "correct": false }
    ],
    ...
    "category": "Digital Services",
    "difficulty": "easy",
    "persona": { "name": "Uncle Ahmad", "age": 60, "bg": "tech beginner", "emoji": "🖱️", "salutation": "Mr", "lastname": "Ahmad" }
  },
  {
    "q": "Which device setting should be set to 'Automatic' to avoid login issues?",
    "choices": [
      { "text": "Brightness.", "correct": false },
      { "text": "Date-time setting.", "correct": true },
      { "text": "Volume.", "correct": false },
      { "text": "Airplane mode.", "correct": false }
    ],
    ...
    "category": "Digital Services",
    "difficulty": "medium",
    "persona": { "name": "Sarah", "age": 35, "bg": "troubleshooting", "emoji": "🕒", "salutation": "Ms", "lastname": "Sarah" }
  },
  {
    "q": "Can you access your CPF statement through the CPF Mobile app?",
    "choices": [
      { "text": "Yes, it provides quick access to your statement and services.", "correct": true },
      { "text": "No, it is only for reading news.", "correct": false },
      { "text": "Only if you pay for a subscription.", "correct": false },
      { "text": "No, statements are only available on desktop.", "correct": false }
    ],
    "explanation": "CPF Mobile is designed to give members easy, on-the-go access to their account information and statements.",
    "category": "Digital Services",
    "difficulty": "easy",
    "persona": { "name": "Wei Kiat", "age": 30, "bg": "using the app", "emoji": "📱", "salutation": "Mr", "lastname": "Wei Kiat" }
  },
  {
    "q": "How can a member prove they do not have a CPF account?",
    "choices": [
      { "text": "By showing their birth certificate.", "correct": false },
      { "text": "By logging in to 'my cpf'; a specific message will confirm they have no account.", "correct": true },
      { "text": "By signing a statutory declaration.", "correct": false },
      { "text": "They cannot prove it.", "correct": false }
    ],
    ...
    "category": "Accounts Management",
    "difficulty": "medium",
    "persona": { "name": "Mr. Schmidt", "age": 40, "bg": "foreigner needing proof", "emoji": "📄", "salutation": "Mr", "lastname": "Schmidt" }
  },
  {
    "q": "What is the CPF account number for a Singapore Citizen?",
    "choices": [
      { "text": "A random 10-digit number.", "correct": false },
      { "text": "The Unique Identification Number (UIN) on their NRIC.", "correct": true },
      { "text": "Their mobile number.", "correct": false },
      { "text": "Their birth certificate number.", "correct": false }
    ],
    "explanation": "For SCs and PRs, the CPF account number is the same as their NRIC number.",
    "category": "Accounts Management",
    "difficulty": "easy",
    "persona": { "name": "Chloe", "age": 21, "bg": "new worker", "emoji": "🆔", "salutation": "Ms", "lastname": "Chloe" }
  },
  {
    "q": "For how many years back can you retrieve your CPF Yearly Statement of Account online?",
    "choices": [
      { "text": "All years since you started working.", "correct": false },
      { "text": "Up to the past 10 years.", "correct": true },
      { "text": "Only the past 3 years.", "correct": false },
      { "text": "Only the current year.", "correct": false }
    ],
    "explanation": "CPF Board provides online access to statements from the past 10 years only.",
    "category": "Accounts Management",
    "difficulty": "medium",
    "persona": { "name": "Paul", "age": 45, "bg": "checking history", "emoji": "📅", "salutation": "Mr", "lastname": "Paul" }
  },
  {
    "q": "Where can you obtain a hardcopy of your CPF statement if you don't have a printer?",
    "choices": [
      { "text": "Any post office.", "correct": false },
      { "text": "At self-service kiosks located at CPF Service Centres.", "correct": true },
      { "text": "From your local library.", "correct": false },
      { "text": "By asking your employer to print it.", "correct": false }
    ],
    "explanation": "Self-service kiosks at CPF Service Centres allow members to print their statements using Singpass.",
    "category": "Accounts Management",
    "difficulty": "medium",
    "persona": { "name": "Uncle Lim", "age": 68, "bg": "retiree", "emoji": "🖨️", "salutation": "Mr", "lastname": "Lim" }
  },
  {
    ...
    "category": "Accounts Management",
    "difficulty": "hard",
    "persona": { "name": "Mdm Tan", "age": 64, "bg": "turning 65 next year", "emoji": "🎂", "salutation": "Mdm", "lastname": "Tan" }
  },
  {
    "q": "If you are 70 in 2024, is your BHS the same as someone turning 65 in 2024?",
    "choices": [
      { "text": "Yes, everyone has the same BHS.", "correct": false },
      { "text": "No, your BHS was fixed at $60,000 when you turned 65 in 2019.", "correct": true },
      { "text": "Yes, it increases for everyone every year.", "correct": false },
      { "text": "No, it is lower for older people.", "correct": false }
    ],
    "explanation": "The BHS is fixed for life once a member turns 65. The 2019 cohort rate was $60,000.",
    "category": "Accounts Management",
    "difficulty": "hard",
    "persona": { "name": "Uncle Seng", "age": 70, "bg": "retiree", "emoji": "👴", "salutation": "Mr", "lastname": "Seng" }
  },
  {
    "q": "Are you required to top up your MediSave if it is below the BHS when you turn 65?",
    "choices": [
      { "text": "Yes, it is mandatory.", "correct": false },
      { "text": "No, but you can choose to make voluntary top-ups.", "correct": true },
      { "text": "Only if you are still working.", "correct": false },
      { "text": "Yes, or you will be fined.", "correct": false }
    ],
    "explanation": "There is no requirement to top up to the BHS, but members can do so to build their healthcare savings.",
    "category": "Accounts Management",
    "difficulty": "medium",
    "persona": { "name": "Auntie Mary", "age": 65, "bg": "checking MA", "emoji": "👵", "salutation": "Mdm", "lastname": "Mary" }
  },
  {
    "q": "When does the 'Second-year rate' for CPF contributions begin for a new SPR?",
    "choices": [
      { "text": "Exactly 12 months after status is granted.", "correct": false },
      { "text": "From the month following the first anniversary of obtaining SPR status.", "correct": true },
      { "text": "On January 1st of the next year.", "correct": false },
      { "text": "When they change jobs.", "correct": false }
    ],
    "explanation": "The graduated rates for SPRs are based on the anniversary month of obtaining their status.",
    "category": "Accounts Management",
    "difficulty": "hard",
    "persona": { "name": "Mei", "age": 30, "bg": "SPR anniversary", "emoji": "🗓️", "salutation": "Ms", "lastname": "Mei" }
  },
  {
    "q": "Can employees receive tax relief for voluntary top-ups to their Ordinary Account?",
    "choices": [
      { "text": "Yes, up to $8,000.", "correct": false },
      { "text": "No, tax relief for voluntary 3-account top-ups is only for self-employed persons.", "correct": true },
      { "text": "Yes, if they are under 35.", "correct": false },
      { "text": "Yes, but only for the employer portion.", "correct": false }
    ],
    ...
    "category": "Accounts Management",
    "difficulty": "hard",
    "persona": { "name": "Grace", "age": 32, "bg": "employee", "emoji": "💼", "salutation": "Ms", "lastname": "Grace" }
  },
  {
    "q": "What is the deadline for making a CPF top-up to be eligible for tax relief in the current year?",
    "choices": [
      { "text": "31 December.", "correct": true },
      { "text": "31 March of the following year.", "correct": false },
      { "text": "15 January.", "correct": false },
      { "text": "Your birthday.", "correct": false }
    ],
    "explanation": "Top-ups must be received by the Board by 31 December to qualify for tax relief for that assessment year.",
    "category": "Accounts Management",
    "difficulty": "medium",
    "persona": { "name": "Ken", "age": 40, "bg": "tax planning", "emoji": "📉", "salutation": "Mr", "lastname": "Ken" }
  },
  {
    "q": "Can you withdraw your CPF Ordinary Account savings to buy a house in London?",
    "choices": [
      { "text": "Yes, for any residential property.", "correct": false },
      { "text": "No, CPF savings can only be used for properties in Singapore.", "correct": true },
      { "text": "Only if you are a Singapore Citizen living there.", "correct": false },
      { "text": "Yes, but with a 10% fee.", "correct": false }
    ],
    "explanation": "CPF housing schemes are restricted to properties located within Singapore.",
    "category": "Accounts Management",
    "difficulty": "easy",
    "persona": { "name": "John", "age": 35, "bg": "investor", "emoji": "🇬🇧", "salutation": "Mr", "lastname": "John" }
  },
  {
    "q": "What happens if an SPR's status is revoked or expires?",
    "choices": [
      { "text": "Their account is closed and savings transferred.", "correct": true },
      { "text": "They lose all their savings.", "correct": false },
      { "text": "The savings are frozen until they turn 55.", "correct": false },
      { "text": "The money is sent to their home country's embassy.", "correct": false }
    ],
    ...
    "category": "Account Closure",
    "difficulty": "medium",
    "persona": { "name": "Carlos", "age": 45, "bg": "former SPR", "emoji": "🛫", "salutation": "Mr", "lastname": "Carlos" }
  },
  {
    "q": "Can you receive Silver Support if you live in a private property but have no income?",
    "choices": [
      { "text": "Yes, it is based only on income.", "correct": false },
      { "text": "No, living in a private property (or a spouse owning one) usually disqualifies you.", "correct": true },
      { "text": "Yes, if you are over 80.", "correct": false },
      { "text": "Only if the property is a small shop.", "correct": false }
    ],
    ...
    "category": "SSS",
    "difficulty": "medium",
    "persona": { "name": "Mr. Koh", "age": 70, "bg": "private property resident", "emoji": "🏠", "salutation": "Mr", "lastname": "Koh" }
  },
  {
    "q": "How is 'household support' measured for Silver Support?",
    "choices": [
      { "text": "By the number of cars owned.", "correct": false },
      { "text": "By the average monthly income per person in the household.", "correct": true },
      { "text": "By the total square footage of the house.", "correct": false },
      { "text": "By the amount of utility bills paid.", "correct": false }
    ],
    ...
    "category": "SSS",
    "difficulty": "hard",
    "persona": { "name": "Siti", "age": 34, "bg": "checking for parents", "emoji": "👨‍👩‍👧‍👦", "salutation": "Ms", "lastname": "Siti" }
  },
  {
    ...
    "category": "SSS",
    "difficulty": "medium",
    "persona": { "name": "Uncle Raj", "age": 72, "bg": "retiree", "emoji": "📅", "salutation": "Mr", "lastname": "Raj" }
  },
  {
    "q": "If you don't use your GovCash balance within the validity period, where does it go?",
    "choices": [
      { "text": "It is forfeited.", "correct": false },
      { "text": "It is credited to your CPF Ordinary Account.", "correct": true },
      { "text": "It is sent to your next-of-kin.", "correct": false },
      { "text": "It is donated to charity.", "correct": false }
    ],
    ...
    "category": "SSS",
    "difficulty": "hard",
    "persona": { "name": "Auntie Mary", "age": 75, "bg": "forgot about GovCash", "emoji": "💰", "salutation": "Mdm", "lastname": "Mary" }
  },
  {
    "q": "Can you use the CPF Mobile app on a rooted or jailbroken phone?",
    "choices": [
      { "text": "Yes, it works on any phone.", "correct": false },
      { "text": "No, for security reasons, it may not function on compromised devices.", "correct": true },
      { "text": "Yes, but only for reading articles.", "correct": false },
      { "text": "Only if you have an antivirus app.", "correct": false }
    ],
    ...
    "category": "Digital Services",
    "difficulty": "medium",
    "persona": { "name": "Wei Kiat", "age": 22, "bg": "tech enthusiast", "emoji": "🛠️", "salutation": "Mr", "lastname": "Wei Kiat" }
  },
  {
    "q": "What happens if your internet connection is unstable while using 'my cpf'?",
    "choices": [
      { "text": "The transaction will wait until you reconnect.", "correct": false },
      { "text": "You may encounter login issues or session timeouts.", "correct": true },
      { "text": "Your account will be locked.", "correct": false },
      { "text": "You will be fined for a bad connection.", "correct": false }
    ],
    "explanation": "Stable internet is required for secure transactions; instability often causes session errors.",
    "category": "Digital Services",
    "difficulty": "easy",
    "persona": { "name": "Linda", "age": 45, "bg": "working from home", "emoji": "📶", "salutation": "Ms", "lastname": "Linda" }
  },
  {
    "q": "How can you tell if a CPF notification you received on your phone is real?",
    "choices": [
      { "text": "If it asks for your bank password.", "correct": false },
      { "text": "Check that it comes from the official CPF Mobile app push notifications.", "correct": true },
      { "text": "If it has a lot of emojis.", "correct": false },
      { "text": "If it offers you a free gift.", "correct": false }
    ],
  ...
  },
  {
    ...
    "choices": [
      { "text": "Yes, if you sign that way.", "correct": false },
      { "text": "No, the Board uses the principal name registered on the NRIC.", "correct": true },
      { "text": "Only for members over 65.", "correct": false },
      { "text": "Yes, if you provide a birth certificate.", "correct": false }
    ],
    "explanation": "Transactions and records are strictly based on the principal name registered with ICA.",
    "category": "Member Particulars",
    "difficulty": "medium",
    "persona": { "name": "Lily", "age": 25, "bg": "student", "emoji": "🔤", "salutation": "Ms", "lastname": "Lily" }
  },
  {
    "q": "If you are helping a senior, can you register your mobile number for their CPF alerts?",
    "choices": [
      { "text": "No, it must be the senior's number.", "correct": false },
      { "text": "Yes, family members can share contact details if they wish.", "correct": true },
      { "text": "Only if you are their legal guardian.", "correct": false },
      { "text": "Yes, but only for one month.", "correct": false }
    ],
    "explanation": "CPF allows sharing of contact details between family members to facilitate assistance for seniors.",
    "category": "Member Particulars",
    "difficulty": "medium",
    "persona": { "name": "Hassan", "age": 42, "bg": "caring son", "emoji": "👨‍👦", "salutation": "Mr", "lastname": "Hassan" }
  },
  {
    "q": "What happens if a parent with Child Dashboard access is no longer a PR or Citizen?",
    "choices": [
      { "text": "They lose access to the dashboard.", "correct": true },
      { "text": "The child loses their CPF money.", "correct": false },
      { "text": "The dashboard is transferred to the child's teacher.", "correct": false },
      { "text": "Access continues until the child is 21.", "correct": false }
    ],
    "explanation": "Dashboard access requires both the parent and child to be SCs or PRs.",
    "category": "Member Particulars",
    "difficulty": "hard",
    "persona": { "name": "Carlos", "age": 48, "bg": "leaving Singapore", "emoji": "✈️", "salutation": "Mr", "lastname": "Carlos" }
  },
  {
    "q": "If you missed the Dec 31st deadline for a top-up, can you get tax relief for the previous year?",
    "choices": [
      { "text": "Yes, with a late fee.", "correct": false },
      { "text": "No, backdating of top-ups is not allowed.", "correct": true },
      { "text": "Yes, if you explain the reason.", "correct": false },
      { "text": "Only if the bank was closed.", "correct": false }
    ],
    "explanation": "Deadlines are strictly enforced; top-ups after Dec 31st count towards the next assessment year.",
    "category": "Accounts Management",
    "difficulty": "easy",
    "persona": { "name": "Wei Ling", "age": 27, "bg": "missed deadline", "emoji": "⌛", "salutation": "Ms", "lastname": "Wei Ling" }
  },
  {
    ...
    "category": "Accounts Management",
    "difficulty": "easy",
    "persona": { "name": "Paul", "age": 30, "bg": "new worker", "emoji": "🏥", "salutation": "Mr", "lastname": "Paul" }
  },
  {
    "q": "What happens to the interest on your CPF savings in April 2024 if you are a non-citizen?",
    "choices": [
      { "text": "It stays at 4%.", "correct": false },
      { "text": "The prevailing CPF interest stops and a commercial rate (0.05%) begins.", "correct": true },
      { "text": "It becomes 0% immediately.", "correct": false },
      { "text": "It is doubled as a bonus.", "correct": false }
    ],
    ...
    "category": "Account Closure",
    "difficulty": "medium",
    "persona": { "name": "David", "age": 52, "bg": "ex-PR", "emoji": "📉", "salutation": "Mr", "lastname": "David" }
  },
  {
    "q": "Can you check the BHS for your specific age cohort on the CPF website?",
    "choices": [
      { "text": "Yes, the Board publishes the BHS for different cohorts.", "correct": true },
      { "text": "No, you must call to find out.", "correct": false },
      { "text": "It is the same for everyone regardless of age.", "correct": false },
      { "text": "It is secret.", "correct": false }
    ],
    "explanation": "The BHS for current and past cohorts is publicly available for reference.",
    "category": "Accounts Management",
    "difficulty": "easy",
    "persona": { "name": "Ken", "age": 55, "bg": "planning for retirement", "emoji": "🔍", "salutation": "Mr", "lastname": "Ken" }
  },
  {
    "q": "Does CPF Board send a letter when they update your name from NRIC records?",
    "choices": [
      { "text": "Yes, always.", "correct": false },
      { "text": "No, it is updated automatically without separate notification.", "correct": true },
      { "text": "Only if you ask for one.", "correct": false },
      { "text": "Only if you are a foreigner.", "correct": false }
    ],
    "explanation": "Automatic updates for core particulars like names are done seamlessly without further acknowledgement.",
    "category": "Member Particulars",
    "difficulty": "medium",
    "persona": { "name": "Lily", "age": 29, "bg": "married name change", "emoji": "💍", "salutation": "Ms", "lastname": "Lily" }
  },
  {
    "q": "What is the primary way for a member abroad to perform CPF transactions?",
    "choices": [
      { "text": "Using 'my cpf' digital services with Singpass.", "correct": true },
      { "text": "Visiting the Singapore Embassy.", "correct": false },
      { "text": "Sending international mail.", "correct": false },
      { "text": "Using a foreign bank account.", "correct": false }
    ],
    "explanation": "Digital services allow members to manage their CPF from anywhere in the world, provided they have Singpass.",
    "category": "Digital Services",
    "difficulty": "easy",
    "persona": { "name": "George", "age": 45, "bg": "living overseas", "emoji": "🌐", "salutation": "Mr", "lastname": "George" }
  },
 }
];
...
const EMAIL_SCENARIOS = [
  ...
  {
    "persona": { "name": "David", "age": 52, "bg": "former PR living abroad", "emoji": "📉", "salutation": "Mr", "lastname": "David" },
    ...
    "categories": ["Account Closure"]
  },
  {
    "persona": { "name": "Hassan", "age": 38, "bg": "father of two", "emoji": "👨‍👦", "salutation": "Mr", "lastname": "Hassan" },
  ...
  {
    "persona": { "name": "Mdm Tan", "age": 64, "bg": "approaching retirement", "emoji": "🎂", "salutation": "Mdm", "lastname": "Tan" },
  ...
  {
    "persona": { "name": "Ben", "age": 31, "bg": "recently moved", "emoji": "📬", "salutation": "Mr", "lastname": "Ben" },
  ...
  {
    "persona": { "name": "Nurse Jane", "age": 30, "bg": "helping a family member", "emoji": "🏥", "salutation": "Ms", "lastname": "Jane" },
  ...
  {
    "persona": { "name": "Wei Kiat", "age": 22, "bg": "tech enthusiast", "emoji": "📱", "salutation": "Mr", "lastname": "Wei Kiat" },
  ...
  {
    "persona": { "name": "Lily", "age": 29, "bg": "newly married", "emoji": "💍", "salutation": "Ms", "lastname": "Lily" },
  ...
  {
    "persona": { "name": "Ken", "age": 40, "bg": "self-employed", "emoji": "📉", "salutation": "Mr", "lastname": "Ken" },
  ...
  {
    "persona": { "name": "Auntie Sim", "age": 73, "bg": "using GovCash", "emoji": "🏧", "salutation": "Mdm", "lastname": "Sim" },
